      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Platform simulasi visual untuk monitoring Smart Farming dan Smart Home. 
            Visualisasi data sensor dan kontrol perangkat dalam satu dashboard terintegrasi.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground mb-6">
                Monihrefring suhu, kelembapan, intensitas cahaya, dan kondisi tanah untuk pertanian cerdas.
              </p>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground mb-6">
                Kontrol lampu, AC, sensor pintu dan gerak untuk rumah pintar yang terintegrasi.
              </p>
